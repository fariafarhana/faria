...
include('image-upload.php'); // Include upload code Script page.

if(!isset($_SESSION['username'])){
    saveError("info","Login First");
        ...
        <div class="image-box">
            ...
            <form method="POST" name="upfrm" action="" enctype="multipart/form-data">
                <div>
                    ...
                    <input type="text" placeholder="Enter Description name" name="img-des" class="tb" />
